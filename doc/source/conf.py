...
init_directory = os.path.join(project_directory, "error_helper_by_delica/")
...
project = 'error-helper-by-delica'
...
autodoc2_packages = [
    "../../error_helper_by_delica/error_helper_funcs.py",
    "../../tests/test_error_helper_funcs.py"
]
