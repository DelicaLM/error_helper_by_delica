...
if test_check_type or run_all_tests:
    test_lib.run_func_tests(error_lib.check_type,
        ...
        IOPair((test_lib.get_rand_letter_mixedcase(), bool, "rand_mixedcase_letter_val"),(TypeError,)),
        IOPair((test_lib.get_rand_letter_mixedcase(), int, "rand_mixedcase_letter_val"),(TypeError,)),
        IOPair((test_lib.get_rand_letter_mixedcase(), float, "rand_mixedcase_letter_val"),(TypeError,)),
        IOPair((test_lib.get_rand_letter_mixedcase(), list, "rand_mixedcase_letter_val"),(TypeError,)),
        # Test check type on a short string of random a-z or A-Z letters.
        IOPair((test_lib.get_rand_az_string_lowercase(test_lib.SHORT_STRING_LENGTH), str, "rand_lowercase_short_az_string_val"),
               (True,)),
        IOPair((test_lib.get_rand_az_string_uppercase(test_lib.SHORT_STRING_LENGTH), str, "rand_uppercase_short_az_string_val"),
               (True,)),
        IOPair((test_lib.get_rand_az_string_mixedcase(test_lib.SHORT_STRING_LENGTH), str, "rand_mixedcase_short_az_string_val"),
               (True,)),
        IOPair((test_lib.get_rand_az_string_mixedcase(test_lib.LONG_STRING_LENGTH), str, "rand_mixedcase_long_az_string_val"),
               (True,)),
        IOPair((test_lib.get_rand_az_string_mixedcase(test_lib.LONG_STRING_LENGTH), bool, "rand_mixedcase_long_az_string_val"),
                (TypeError,)),
        IOPair((test_lib.get_rand_az_string_mixedcase(test_lib.LONG_STRING_LENGTH), int, "rand_mixedcase_long_az_string_val"),
               (TypeError,)),
        IOPair((test_lib.get_rand_az_string_mixedcase(test_lib.LONG_STRING_LENGTH), float, "rand_mixedcase_long_az_string_val"),
               (TypeError,)),
        IOPair((test_lib.get_rand_az_string_mixedcase(test_lib.LONG_STRING_LENGTH), list, "rand_mixedcase_long_az_string_val"),
                (TypeError,)),
        ...
        IOPair((test_lib.get_rand_bool_list(test_lib.SHORT_LIST_LENGTH), list, "short_bool_list"), (True,)),
        IOPair((test_lib.get_rand_bool_list(test_lib.SHORT_LIST_LENGTH), bool, "short_bool_list"), (TypeError,)),
        IOPair((test_lib.get_rand_bool_list(test_lib.SHORT_LIST_LENGTH), int, "short_bool_list"), (TypeError,)),
        IOPair((test_lib.get_rand_bool_list(test_lib.SHORT_LIST_LENGTH), float, "short_bool_list"), (TypeError,)),
        IOPair((test_lib.get_rand_bool_list(test_lib.SHORT_LIST_LENGTH), str, "short_bool_list"), (TypeError,)),
        ...
        IOPair((test_lib.get_rand_int_list(test_lib.SHORT_LIST_LENGTH), list, "short_int_list"), (True,)),
        IOPair((test_lib.get_rand_int_list(test_lib.SHORT_LIST_LENGTH), bool, "short_int_list"), (TypeError,)),
        IOPair((test_lib.get_rand_int_list(test_lib.SHORT_LIST_LENGTH), int, "short_int_list"), (TypeError,)),
        IOPair((test_lib.get_rand_int_list(test_lib.SHORT_LIST_LENGTH), float, "short_int_list"), (TypeError,)),
        IOPair((test_lib.get_rand_int_list(test_lib.SHORT_LIST_LENGTH), str, "short_int_list"), (TypeError,)),
        ...
        # Test check type on a short list with random integer elements.
        IOPair((test_lib.get_rand_float_list(test_lib.SHORT_LIST_LENGTH), list, "short_float_list"), (True,)),
        IOPair((test_lib.get_rand_float_list(test_lib.SHORT_LIST_LENGTH), bool, "short_float_list"), (TypeError,)),
        IOPair((test_lib.get_rand_float_list(test_lib.SHORT_LIST_LENGTH), int, "short_float_list"), (TypeError,)),
        IOPair((test_lib.get_rand_float_list(test_lib.SHORT_LIST_LENGTH), float, "short_float_list"), (TypeError,)),
        IOPair((test_lib.get_rand_float_list(test_lib.SHORT_LIST_LENGTH), str, "short_float_list"), (TypeError,)),
        ...
        IOPair(([test_lib.get_rand_letter_mixedcase()], bool, "single_letter_list"), (TypeError,)),
        IOPair(([test_lib.get_rand_letter_mixedcase()], int, "single_letter_list"), (TypeError,)),
        IOPair(([test_lib.get_rand_letter_mixedcase()], float, "single_letter_list"), (TypeError,)),
        ...
        IOPair((test_lib.get_rand_letter_list(test_lib.SHORT_LIST_LENGTH), list, "short_letter_list"), (True,)),
        IOPair((test_lib.get_rand_letter_list(test_lib.SHORT_LIST_LENGTH), bool, "short_letter_list"), (TypeError,)),
        IOPair((test_lib.get_rand_letter_list(test_lib.SHORT_LIST_LENGTH), int, "short_letter_list"), (TypeError,)),
        IOPair((test_lib.get_rand_letter_list(test_lib.SHORT_LIST_LENGTH), float, "short_letter_list"), (TypeError,)),
        IOPair((test_lib.get_rand_letter_list(test_lib.SHORT_LIST_LENGTH), str, "short_letter_list"), (TypeError,)),
        # Test check type on a list that contains a single short string element.
        IOPair(([test_lib.get_rand_az_string_mixedcase(test_lib.SHORT_STRING_LENGTH)], list, "single_az_string_list"),
               (True,)),
        IOPair(([test_lib.get_rand_az_string_mixedcase(test_lib.SHORT_STRING_LENGTH)], bool, "single_az_string_list"),
               (TypeError,)),
        IOPair(([test_lib.get_rand_az_string_mixedcase(test_lib.SHORT_STRING_LENGTH)], int, "single_az_string_list"),
               (TypeError,)),
        IOPair(([test_lib.get_rand_az_string_mixedcase(test_lib.SHORT_STRING_LENGTH)], float, "single_az_string_list"),
               (TypeError,)),
        IOPair(([test_lib.get_rand_az_string_mixedcase(test_lib.SHORT_STRING_LENGTH)], str, "single_az_string_list"),
               (TypeError,)),
        # Test check type on a short list that contains random strings as elements.
        IOPair((test_lib.get_rand_mixedcase_az_string_list(test_lib.SHORT_LIST_LENGTH), list, "short_az_string_list"),
               (True,)),
        IOPair((test_lib.get_rand_mixedcase_az_string_list(test_lib.SHORT_LIST_LENGTH), bool, "short_az_string_list"),
               (TypeError,)),
        IOPair((test_lib.get_rand_mixedcase_az_string_list(test_lib.SHORT_LIST_LENGTH), int, "short_az_string_list"),
               (TypeError,)),
        IOPair((test_lib.get_rand_mixedcase_az_string_list(test_lib.SHORT_LIST_LENGTH), float, "short_az_string_list"),
               (TypeError,)),
        IOPair((test_lib.get_rand_mixedcase_az_string_list(test_lib.SHORT_LIST_LENGTH), str, "short_az_string_list"),
               (TypeError,)),
...
if test_check_can_convert or run_all_tests:
    test_lib.run_func_tests(error_lib.check_can_convert,[
        ...
        IOPair((test_lib.get_rand_az_string_mixedcase(test_lib.SHORT_STRING_LENGTH), str, "single_az_letter"),
               (True,)),
        IOPair((test_lib.get_rand_az_string_mixedcase(test_lib.SHORT_STRING_LENGTH), list, "single_az_letter"),
               (True,)),
        IOPair((test_lib.get_rand_az_string_mixedcase(test_lib.SHORT_STRING_LENGTH), bool, "single_az_letter"),
               (True,)),
        IOPair((test_lib.get_rand_az_string_mixedcase(test_lib.SHORT_STRING_LENGTH), int, "single_az_letter"),
               (TypeError,)),
        IOPair((test_lib.get_rand_az_string_mixedcase(test_lib.SHORT_STRING_LENGTH), float, "single_az_letter"),
               (TypeError,)),
        ...
        IOPair((test_lib.get_rand_int_list(test_lib.SHORT_LIST_LENGTH), list, "short_int_list"), (True,)),
        IOPair((test_lib.get_rand_int_list(test_lib.SHORT_LIST_LENGTH), str, "short_int_list"), (True,)),
        IOPair((test_lib.get_rand_int_list(test_lib.SHORT_LIST_LENGTH), bool, "short_int_list"), (True,)),
        ...
        IOPair((test_lib.get_rand_int_list(test_lib.LONG_LIST_LENGTH), list, "long_int_list"), (True,)),
        IOPair((test_lib.get_rand_int_list(test_lib.LONG_LIST_LENGTH), str, "long_int_list"), (True,)),
        IOPair((test_lib.get_rand_int_list(test_lib.LONG_LIST_LENGTH), bool, "long_int_list"), (True,)),
